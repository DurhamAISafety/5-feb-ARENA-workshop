# %% [markdown]
# # [1.1] - Transformers from scratch (solutions)
# 
# > **ARENA [Streamlit Page](https://arena-chapter1-transformer-interp.streamlit.app/01_[1.1]_Transformer_from_Scratch)**
# >
# > **Colab: [exercises](https://colab.research.google.com/github/DurhamAISafety/5-feb-ARENA-workshop/blob/main/exercises_copy.ipynb) | [solutions](https://colab.research.google.com/github/DurhamAISafety/5-feb-ARENA-workshop/blob/main/solns_copy.ipynb)**
# >
# > **DAISI Repo: https://github.com/DurhamAISafety/5-feb-ARENA-workshop**
# 
...
# 
# https://www.youtube.com/watch?v=11Z50mi8dSg
...
try:
    ...
    %pip install -U transformer_lens transformers
    %pip install einops jaxtyping git+https://github.com/callummcdougall/CircuitsVis.git#subdirectory=python
